...
#Misfits 
cost = Nokogiri::HTML(open("https://finance.yahoo.com/quote/AMCR?p=AMCR&.tsrc=fin-srch"))
binding.pry
# Stock Price
cost.css('#quote-header-info').css("span").children[1].inner_text
#Stock Change
cost.css("#quote-header-info").css("span")[2].inner_text
#Stock Time
stock_time = cost.css('#quote-market-notice').inner_text
# Daily High-Low
cost.css("#quote-summary").css("td")[9].inner_text
# 52 Two Week High-Low
cost.css("#quote-summary").css("td")[11].inner_text

# fixes number converting issues
